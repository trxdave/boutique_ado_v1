...
try:
    import env  # This will load the env.py file
except ImportError:
    pass
...
ALLOWED_HOSTS = ['8000-trxdave-boutiqueadov1-flwdea0umgv.ws.codeinstitute-ide.net', 'localhost',
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'boutique-ado-dc'
